...
window.addEventListener("DOMContentLoaded", function () {
  "use strict"; //створюємо об'єкт з тими даними, які ми маємо відправити

  var modalState = {}; //дату прописуєм

  var deadline = "2023-05-22";
...
var forms = function forms(state) {
  var form = document.querySelectorAll("form"),
      inputs = document.querySelectorAll("input"); //виклик ф-ції валідації чи цифра з модуля checkNumbers
...
var modals = function modals() {
  //Прив'язка мод. вікна до визначеного тригера
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener("click", function (e) {
        ...
        document.body.style.marginRight = "".concat(scroll, "px "); //берем клас з будстрапа
    ...
    close.addEventListener("click", function () {
      ...
      document.body.style.marginRight = "0px "; //берем клас з будстрапа
  ...
  } //   Якщо користувач на сторінці більше !..! секунд - з'явиться модальне вікно (popup).
  //   При натисканні на хрестик або на підкладку вікно зникає.
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  hideTabContent();
  showTabContent(); //відстежити який таб клікнув користувач,делегування подій
  //header - блок що об'єднює всі наші таби

  header.addEventListener("click", function (e) {
    //e.target - той елемент на якому відбулась подія,куда клікнув користувач.
    var target = e.target; //відділити крапку, бо в фунції закладено спочатку посилання на селектор,через крапку  (tabSelector.replace(/\./, "")
...
//підтягує jquery  з node modules
